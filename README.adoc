...
In addition to those main points, supermodel elements should be documented with basic annotation predicates such as `schema:name` to indicate an element's name.
